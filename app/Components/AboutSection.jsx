  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        ...
        <li>Agile Development Team Project</li>
        <li>Fuzzy Logic</li>
  ...
  return (
    <section className="text-white" id="about">
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        <Image src="/images/about2.jpg" alt="about" width={500} height={500} />
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          <h2 className="text-4xl font-bold text-white mb-4">More About Me</h2>
          ...
          <div className="flex flex-row justify-start mt-8">
            ...
            >
              {" "}
              Certifications and Basic Knowledge in some areas{" "}
            </TabButton>
          </div>
          <div className="mt-8">
